            ...
            <div className="container-fluid pageContent">
                <div className="row col-lg-12 col-sm-12 rowContainer">
                    ...
                    <div className="col-lg-9 col-sm-12 topicContents">
                        <h1 className="text-center m-3">HTML/5 Text Elements</h1>
                    ...
                    <div className="col-lg-9 col-sm-12 topicContents">
                        <div className="structuralMarkupContainer">
                            <span id="structuralMarkupAnchor"></span>
                            ...
                            <div id="headings">
                                <div id="htmlDir_1_1" className="row">
                                    <h3 className="subHeading">1. The Headings Elements</h3>
                                    <div className="col-sm-12 col-lg-12">
                                        <p className="textEntry_1">
                                            HTML5 has six (6) levels of headings:
                                        </p>
                                        <div className="row">
                            ...
                            <hr className="hrStyle"/>
                            <div id="paragraphs">
                                <div id="htmlDir_1_2" className="row">
                                    <h3 className="subHeading">2. The Paragraph Element</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <p className="textEntry_1">HTML5 provides the paragraph tag &lt;p&gt; to set
                            ...
                            <hr className="hrStyle"/>
                            <div id="emphasis">
                                <div id="htmlDir_1_3" className="row">
                                    <h3 className="subHeading">3. Bold, Italic, Superscript, & Subscript Elements</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div className="row col-lg-12 col-sm-12">
                                            <div
                                                className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1"
                            ...
                            <hr className="hrStyle"/>
                            <div id="whitespace">
                                <div id="htmlDir_1_4" className="row">
                                    <h3 className="subHeading">4. White Space</h3>
                                    <p className="textEntry_1">
                                        ...
                                        well. This is known as
                                        <strong>white space collapsing</strong>.
                                    </p>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div className="row col-lg-12 col-sm-12">
                      ...
                      is drifting                         away from Earth.&lt;/p&gt;
                            ...
                            <div id="lineBreaksAndHR">
                                <div id="htmlDir_1_5" className="row">
                                    <h3 className="subHeading lbHRSubHeading">5. Line Breaks & Horizontal Rules</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <p className="textEntry_1">
                                            There are two (2) <strong>self-closing</strong> tags to help with line
                                            breaks and horizontal rules.<br/>
                                            They are &lt;br/&gt; and &lt;hr/&gt;. They are also known as <strong>Empty
                                            Elements</strong>.
                                        </p>
                                        <div
                                            className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1"
                                        ...
                                        >
                                            ...
                                            <p>
                                                Used to create a break between theme - such as a change in topic.
                                            </p>
                                        </div>
                                        <div
                                            className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel2"
                                        >
                                            <div className="tablePanel2">
                                                ...
                                                <hr/>
                                                <p className="example tablePanel3">Jupiter is bigger than all the other
                                                    planets combined.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="structuralMarkupContainer">
                            ...
                            <div id="strongAndEmphasisSection">
                                <div id="htmlDir_1_6" className="row">
                                    <h3 className="subHeading">1. Strong &amp; Emphasis</h3>
                                    <div className="col-sm-12 col-lg-12">
                                        <div className="row">
                                            <div className="row col-lg-12 col-sm-12">
                                                <div
                            ...
                            <div id="quotationsSection">
                                <div id="htmlDir_1_7" className="row">
                                    <h3 className="subHeading">2. Quotations &amp; Citations</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <p className="textEntry_1">
                                        ...
                                        <div
                                            ...
                                            <blockquote cite="https://en.wikipedia.org/wiki/Custard_apple">
                                                <p className="example tablePanel3">The Annonaceae are a family of
                            ...
                            <div id="abbreviationsAndAcronymsSection">
                                <div id="htmlDir_1_8" className="row">
                                    <h3 className="subHeading">3. Abbreviations &amp; Acronyms</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div className="row col-lg-12 col-sm-12">
                                            <div
                                                className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1">
                            ...
                            <div id="definitionsSection">
                                <div id="htmlDir_1_9" className="row">
                                    <h3 className="subHeading">4. Definitions</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div className="row col-lg-12 col-sm-12">
                                            <div
                                                className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1"
                            ...
                            <div id="addressSection">
                                <div id="htmlDir_1_10" className="row">
                                    <h3 className="subHeading lbHRSubHeading">5. Address</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div
                                            className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1">
                                            <p>
                            ...
                            <div id="contentChangesSection">
                                <div id="htmlDir_1_11" className="row">
                                    <h3 className="subHeading lbHRSubHeading">6. Content Changes</h3>
                                    <div className="row col-lg-12 col-sm-12">
                                        <div
                                            className="col-lg-6 col-sm-12 p-3 text-center align-content-center tablePanel1"
                                        >
