                                    ...
                                    <div className="row col-lg-12 col-sm-12">
                                        ...
                                        <div className="row col-lg-12 col-sm-12">
                                            ...
                                            <div
                                                className="col-lg-5 col-sm-12 p-3 text-center align-content-center tablePanel2"
                                            >
                                                <p className="example tablePanel3 bodyText_6">
                                        ...
                                        <div className="row col-lg-12 col-sm-12">
                                            ...
                                            <div
                                                className="col-lg-5 col-sm-12 p-3 text-center align-content-center tablePanel2"
                                            >
                                                <p className="example tablePanel3 bodyText_6">The moon is drifting away from
                                                    Earth.</p>
                                            </div>
                                        </div>
                                        <div className="row col-lg-12 col-sm-12">
                                    ...
                                    <div className="row col-lg-12 col-sm-12">
                                        ...
                                        <div
                                            ...
                                            <p className={"bodyText_3 text-start"}>
                                                ...
                                                the <strong>cite</strong> attribute to indicate where a quote is from.
                                                Its value should be a URL that will have more information about the
                            ...
                            <div id="contentChangesSection">
                                <div id="htmlDir_1_11" className="row">
                                    ...
                                    <div className="row col-lg-12 col-sm-12 p-2">
                                        ...
                                        >
                                            <p className="example tablePanel3 bodyText_4">
                                                It was the <ins>best</ins> idea I had.
                                            </p>
                                        </div>
                                        ...
                                        >
                                            <p className="example tablePanel3">
                                                It was the <del>best</del> <ins>worst</ins> idea I had.
                                            </p>
                                        </div>
